...
:::{iframe} https://www.youtube.com/embed/eJFJRyXEHZ0
:width: 100%
:::
...
<a class="button" href="https://www.kaggle.com/models/google/gemma-3n">Get it on Kaggle</a>
<a class="button" href="https://huggingface.co/collections/google/gemma-3n-685065323f5984ef315c93f4">Get it on Hugging Face</a>

As with other Gemma models, Gemma 3n is provided with open weights and
licensed for responsible [commercial use](/terms), allowing you to tune
...
![Gemma 3n diagram of parameter usage](/images/gemma-3n-parameters.png)
