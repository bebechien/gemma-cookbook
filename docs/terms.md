...
3. You must cause any modified files to carry prominent notices stating that you
modified the files.
...
[ai.google.dev/gemma/prohibited_use_policy](prohibited_use_policy)
...
Note: Previous versions of these Terms are [archived here](terms-archive/).
